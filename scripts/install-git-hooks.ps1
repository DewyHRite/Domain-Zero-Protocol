...
$marker = 'Domain Zero Protocol - Agent / Protected-File Commit Guard'
...
if ((Test-Path $dest) -and -not (Select-String -Path $dest -SimpleMatch $marker -Quiet)) {
...
Write-Host "[OK] Installed DZP pre-commit hook: $dest"
