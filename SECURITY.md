...
| ------- | ------------------ | ------ |
| 8.7.0   | :white_check_mark: | Current stable release |
...
**Upgrade Recommendation**: Users on unsupported versions should upgrade to v8.7.0 immediately.
...
- **Current Version**: 1.3.0 (matches Domain Zero Protocol v8.7.0)
