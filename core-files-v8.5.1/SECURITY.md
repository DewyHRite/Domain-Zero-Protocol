...
| ------- | ------------------ | ------ |
| 8.5.1   | :white_check_mark: | Current stable release |
...
**Upgrade Recommendation**: Users on unsupported versions should upgrade to v8.5.1 immediately.
...
- **Current Version**: 1.1.0 (matches Domain Zero Protocol v8.5.1)
