...
cp -r "Domain Zero Protocol v6.2.2/protocol" your-project/
cp -r "Domain Zero Protocol v6.2.2/.protocol-state" your-project/
cp "Domain Zero Protocol v6.2.2/protocol.config.yaml" your-project/
cp "Domain Zero Protocol v6.2.2/.gitignore" your-project/
```

**Windows (PowerShell)**:
```powershell
# Copy the entire protocol structure to your project root
Copy-Item -Recurse -Force "Domain Zero Protocol v6.2.2\protocol" -Destination "your-project\"
Copy-Item -Recurse -Force "Domain Zero Protocol v6.2.2\.protocol-state" -Destination "your-project\"
Copy-Item -Force "Domain Zero Protocol v6.2.2\protocol.config.yaml" -Destination "your-project\"
Copy-Item -Force "Domain Zero Protocol v6.2.2\.gitignore" -Destination "your-project\"
```

**Windows (Command Prompt)**:
```cmd
REM Copy the entire protocol structure to your project root
xcopy /E /I /Y "Domain Zero Protocol v6.2.2\protocol" "your-project\protocol"
xcopy /E /I /Y "Domain Zero Protocol v6.2.2\.protocol-state" "your-project\.protocol-state"
copy /Y "Domain Zero Protocol v6.2.2\protocol.config.yaml" "your-project\"
copy /Y "Domain Zero Protocol v6.2.2\.gitignore" "your-project\"
```
...
- protocol/CLAUDE.md (main protocol, v6.2.2)
...
- ✅ Protocol name and version (Domain Zero Protocol v6.2.2)
...
**Domain Zero Protocol v6.2.2** - Perfect Code Through Infinite Collaboration
