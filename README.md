...
> **New in v8.7.0**: Custom Agent Security Framework (8 critical vulnerabilities fixed, pre-invocation validation, runtime monitoring, audit logging). See [What's New](#-version-information).
