...
export async function verifyProtocol(root) {
  ...
  try {
    await fs.access(path.join(root, "protocol/YUUJI.md"));
    await fs.access(path.join(root, "protocol/MEGUMI.md"));
  } catch {
    errors.push("Missing protocol/YUUJI.md or protocol/MEGUMI.md");
  }
